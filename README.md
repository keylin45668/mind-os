...
### 方式三：直接从 GitHub 安装（本地没有 Mind OS）
...
整个系统从一个公式推导出来：`context = schema ⊕ theory ⊕ data`。经历了 v1 到 v5 共 21 层"审计→发现违反→重构"的剥洋葱过程，融合了多本经典和多套理论的核心方法论。详见 [DESIGN-NOTES.md](mind-os/DESIGN-NOTES.md)。
...
| 想做什么 | 参考 |
|---------|------|
| 创建 theory pack | [theories/rational/README.md](mind-os/theories/rational/README.md) |
| 新增领域 | [domains/_router.md](mind-os/domains/_router.md) |
| 接入外部项目 | [projects/INSTALL.md](mind-os/projects/INSTALL.md) |
| 切换配置 | [config.md](mind-os/config.md) |
| 跑自迭代 | 说"autoevolve" |
| 理解设计推导 | [DESIGN-NOTES.md](mind-os/DESIGN-NOTES.md) |
...
当前版本：**v5.1**（见 [CHANGELOG.md](mind-os/CHANGELOG.md)）
